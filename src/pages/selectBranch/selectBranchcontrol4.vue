    ...
    <Layout style="height: 100vh;">
      <Sider :width="251" style="background: #343957;">
        ...
        <Menu width="100%" :active-name="fullPath" :open-names="[openname]" accordion>
          <MenuItem name="controlentirety" to="/selectBranchControl4/control">
...
export default {
  ...
  computed: {
    fullPath() {
      if (this.$route.path == '/selectBranchControl4/control') {
        this.openname = 'control'
        return 'controlentirety'
      } else if (this.$route.path == '/selectBranchControl4/specifics/control') {
        this.openname = 'control'
