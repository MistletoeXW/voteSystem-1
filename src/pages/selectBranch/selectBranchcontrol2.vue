    ...
    <Layout style="height: 100vh;">
      <Sider :width="251" style="background: #343957;">
        ...
        <Menu width="100%" :active-name="fullPath" :open-names="[openname]" accordion>
          ...
          <MenuItem name="onlineentirety" to="/selectBranchControl2/count">
            <Icon type="ios-paper" />
            <span>计票页面</span>
          </MenuItem>

          <MenuItem name="offNetworkentirety" to="/selectBranchControl2/offNetwork">
...
export default {
  ...
  computed: {
    fullPath() {
      if (this.$route.path == '/selectBranchControl2/count') {
        this.openname = 'online'
        return 'onlineentirety'
      } else if (this.$route.path == '/selectBranchControl2/control') {
        this.openname = 'control'
        return 'controlentirety'
      } else if (this.$route.path == '/selectBranchControl2/specifics/control') {
        this.openname = 'control'
        return 'controlspecifics'
      } else if (this.$route.path == '/selectBranchControl2/specifics/count') {
        this.openname = 'online'
        return 'onlinespecifics'
      } else if (
        this.$route.path == '/selectBranchControl2/specifics/offNetwork'
      ) {
