    ...
    <Layout style="height: 100vh;">
      <Sider :width="251" style="background: #343957;">
        ...
        <Menu width="100%" :active-name="fullPath" :open-names="[openname]" accordion>
          <MenuItem name="controlentirety" to="/selectBranchControl/control">
            <Icon type="ios-settings" />
            <span>管理页面</span>
          </MenuItem>

          <MenuItem name="onlineentirety" to="/selectBranchControl/count">
            <Icon type="ios-paper" />
            <span>计票页面</span>
          </MenuItem>

          <MenuItem name="offNetworkentirety" to="/selectBranchControl/offNetwork">
            <Icon type="ios-people" />
            <span>线下投票</span>
          </MenuItem>

          <MenuItem name="voteentirety" to="/selectBranchControl/vote">
            <Icon type="md-person" />
            <span>线上投票</span>
          </MenuItem>
        </Menu>
...
export default {
  ...
  computed: {
    fullPath() {
      if (this.$route.path == "/selectBranchControl/count") {
        this.openname = "online";
        return "onlineentirety";
      } else if (this.$route.path == "/selectBranchControl/control") {
        this.openname = "control";
        return "controlentirety";
      } else if (this.$route.path == "/selectBranchControl/vote") {
        this.openname = "vote";
        return "voteentirety";
      } else if (this.$route.path == "/selectBranchControl/specifics/control") {
        this.openname = "control";
        return "controlspecifics";
      } else if (this.$route.path == "/selectBranchControl/specifics/count") {
        this.openname = "online";
        return "onlinespecifics";
      } else if (
        this.$route.path == "/selectBranchControl/specifics/offNetwork"
      ) {
        this.openname = "offNetwork";
        return "offNetworkspecifics";
      } else if (this.$route.path == "/selectBranchControl/specifics/vote") {
        this.openname = "vote";
