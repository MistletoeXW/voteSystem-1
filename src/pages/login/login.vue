      ...
      this.$axios({
        ...
        .then(res => {
          ...
          if (res.data.code === "SUCCESS") {
            ...
            else if (this.identity[0] == "2") {
              if (this.identity == "21") {
                this.$router.push({ path: "/selectBranchControl2/control" });
              } else if (this.identity == "20") {
                this.$router.push({ path: "/selectBranchControl3/control" });
              } else if (this.identity == "210") {
                this.$router.push({ path: "/selectBranchControl/control" });
              } else {
                this.$router.push({ path: "/selectBranchControl4/control" });
              }
            } else if (this.identity[0] == "1") {
              if (this.identity == "10") {
                this.$router.push({ path: "/selectBranchCount/count" });
              } else {
                this.$router.push({ path: "/selectBranchCount2/count" });
              }
            } else if (this.identity == "0") {
              this.$router.push({ path: "/selectBranchVoter/vote" });
            } else {
