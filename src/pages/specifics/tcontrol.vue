<template>
  <div style="height:100%">
    <Tabs :value="theTabs" style="margin-left:5%;margin-top:2%" size="small" @on-click="tabClick">
        ...
        <div class="action">
          ...
          >
            ...
            <Col span="17">
              ...
              >置零</Button>
              <Button type="success" @click="addCandidates=true">增加候选人</Button>
            </Col>
            <Col span="2">
      ...
      <TabPane label="计票员" name="counter">
        <div class="action">
          ...
          >
            ...
            <Col span="17">
              <Button type="success" @click="dialogFormVisible1=true" style="margin-left:1vw">增加计票员</Button>
            </Col>
            <Col span="2">
              <Button type="info" @click="handleOnClickRefresh()">刷新</Button>
            </Col>
        ...
        <div class="Table">
          <div class="tablemain">
            <Table stripe :columns="columnsc" :data="datac" height="450" :loading="loading"></Table>
          </div>
        </div>
      </TabPane>
      <TabPane label="投票员" name="voter" v-if="votingmode=='线上投票'">
        <div class="action">
          ...
          >
            ...
            <Col span="17">
                ...
                <Button type="success" @click="addVoter=true" style="margin-left:1vw">增加投票员</Button>
        ...
        <div class="Table">
          <div class="tablemain">
            <Table stripe :columns="columnsv" :data="datav" height="420" :loading="loading"></Table>
          </div>
...
export default {
    ...
    loadData2() {
      ...
      axios({
        ...
        .then(res => {
          ...
          if (res.data.code === "SUCCESS") {
            if (res.data.data != null) {
              this.totalVoter = res.data.data.totalVoter;
              this.datav = res.data.data.votersList;
            }
          } else {
            this.$Notice.warning({ title: `出错，提示：${res.data.message}` });
  ...
  mounted() {
    ...
    this.votingmode = this.$route.query.votingmode;
  },
